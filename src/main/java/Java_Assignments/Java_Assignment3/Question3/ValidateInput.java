package Java_Assignments.Java_Assignment3.Question3;
...
public class ValidateInput {
   ...
   public static boolean validateFirstName(String firstName) {
      return firstName.matches("^{2,}[A-Z][a-zA-Z]*");
   } 
   ...
   public static boolean validateState(String state) {
      return state.matches("^[a-zA-Z]+(\\s[a-zA-Z]+){0,2}$") ;
   }

   // validate zip
   public static boolean validateZip(String zip) {
      return zip.matches("^\\d{5}|[A-Z][0-9][A-Z][0-9][A-Z][0-9]");
   }
